...
func TestOrganizationsService_CreateHook(t *testing.T) {
	...
	hook, _, err := client.Organizations.CreateHook("o", input)
	if err != nil {
...
func TestOrganizationsService_CreateHook_invalidOwner(t *testing.T) {
	_, _, err := client.Organizations.CreateHook("%", nil)
...
func TestOrganizationsService_ListHooks_invalidOwner(t *testing.T) {
...
func TestOrganizationsService_GetHook_invalidOwner(t *testing.T) {
...
func TestOrganizationsService_EditHook_invalidOwner(t *testing.T) {
...
func TestOrganizationsService_DeleteHook_invalidOwner(t *testing.T) {
	_, err := client.Organizations.DeleteHook("%", 1)
	testURLParseError(t, err)
}

func TestOrganizationsService_TestHook(t *testing.T) {
	setup()
	defer teardown()

	mux.HandleFunc("/orgs/o/hooks/1/tests", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, "POST")
	})

	_, err := client.Organizations.TestHook("o", 1)
	if err != nil {
		t.Errorf("Organizations.TestHook returned error: %v", err)
	}
}

func TestOrganizationsService_TestHook_invalidOwner(t *testing.T) {
	_, err := client.Organizations.TestHook("%", 1)
	testURLParseError(t, err)
}
